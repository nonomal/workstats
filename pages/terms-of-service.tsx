  ...
  return (
    <>
      ...
      <main className='bg-slate-50 px-1 md:px-16'>
        ...
        <p className='py-1'>
          We employ the use of cookies. By accessing WorkStats, you agreed to
          use cookies in agreement with the Suchica, Inc.'s Privacy Policy.
        </p>
        ...
        <h2 className='text-2xl py-4'>2. License</h2>

        <p className='py-1'>
          Unless otherwise stated, Suchica, Inc. and/or its licensors own the
        ...
        <ul className='py-1 list-disc list-inside' role='list'>
          <li>Republish material from WorkStats</li>
          <li>Sell, rent or sub-license material from WorkStats</li>
          <li>Reproduce, duplicate or copy material from WorkStats</li>
          <li>Redistribute content from WorkStats</li>
        </ul>
        ...
        <p className='py-1'>
          ...
          Suchica, Inc. does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Suchica, Inc., its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Suchica, Inc.
        ...
        <p className='py-1'>
          ...
          the hyperlink compensates the absence of Suchica, Inc.; and (d) the
        ...
        <p className='py-1'>
          No use of Suchica, Inc.'s logo or other artwork will be allowed for
          linking absent a trademark license agreement.
        </p>

        <h2 className='text-2xl py-4'>4. iFrames</h2>
        ...
        <h2 className='text-2xl py-4'>5. Content Liability</h2>
        ...
        <h2 className='text-2xl py-4'>6. Your Privacy</h2>

        <p className='py-1'>
          Please read{' '}
          <Link href='/privacy-policy'>
            <a className='py-1 text-blue-600'>Privacy Policy</a>
          </Link>
        </p>

        <h2 className='text-2xl py-4'>7. Reservation of Rights</h2>
        ...
        <h2 className='text-2xl py-4'>9. Disclaimer</h2>
